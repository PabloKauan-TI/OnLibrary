    ...
    <div class="form">
        <div class="container">
            <fieldset>
                ...
                <form action="assets/php/alt_livro.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col">
                            <label for="titulo_livro" class="form-label">Nome</label>
                            <input type="text" name="titulo_livro" class="form-control" placeholder="" value="<?php echo $data['titulo_livro'] ?>">
                        </div>
                        <!-- <div class="col-3">
                    ...
                    <div class="row">
                        <div class="col-9">
                            ...
                            <input type="text" name="autor_livro" class="form-control" placeholder="" value="<?php echo $data['autor_livro'] ?>">
                        </div>
                        <div class="col-3">
                            <label for="qtd_livro" class="form-label">Quantidade</label>
                            <input type="text" name="qtd_livro" class="form-control" placeholder="" value="<?php echo $data['qtd_livro'] ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label for="imagem_livro" class="form-label">Capa</label>
                            <input type="file" name="imagem_livro" class="form-control" placeholder="" value="<?php echo $data['imagem_livro'] ?>">
                        </div>
                    </div>
