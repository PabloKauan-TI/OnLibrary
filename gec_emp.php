...
<body>
    ...
    <div id="pesq">
        <form action="gec_emp.php" method="post">
            <div class="col">
                <div class="input-group mb-3">
                    <input type="search" class="form-control" placeholder="Todos os emprestimos..." name="pesquisar">
        ...
        <div class="border">
            <table class="table table-dark">
                <thead>
                    ...
                    <th scope="col">RECEBER EM</th>
                    <th scope="col">OPÇÕES</th>
                </thead>
                <tbody>
                    <?php while ($dado = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        <th><?php echo $dado['aluno']; ?></th>
                        <th><?php echo $dado['serie']; ?></th>
                        <th><?php echo $dado['curso']; ?></th>
                        <th><?php echo $dado['titulo_livro']; ?></th>
                        <th><?php echo $dado['data_emp']; ?></th>
                        <th><?php echo $dado['data_rec']; ?></th>
                        <th>
                            <button class="btn btn-secondary"><a href="alt_emprestimo.php?cod_emp=<?php echo $dado['cod_emp']; ?>"><img src="assets/css/escrever.png"></a></button>
