    ...
    <div class="form">
        <div class="container">
            <fieldset>
                ...
                if ($_GET['id_bibliotecaria']) {
                    $aluno = $_GET['id_bibliotecaria'];

                    $sql = "SELECT * FROM cadbibliotecaria WHERE id_bibliotecaria = {$aluno}";
                ...
                ?>
                     <form action="assets/php/edit_bibliotecaria.php" method="post">
                    <div class="row">
                        <div class="col-9">
                            <label for="nome_bibliotecaria" class="form-label">Nome</label>
                            <input type="text" name="nome_bibliotecaria" class="form-control" placeholder="" value="<?php echo $dado['nome_bibliotecaria'] ?>">
                        </div>
                        <div class="col-3">
                            <label for="id_bibliotecaria" class="form-label">Id</label>
                            <input type="text" name="id_bibliotecaria" class="form-control" placeholder="" value="<?php echo $dado['id_bibliotecaria'] ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label for="endereco_bibliotecaria" class="form-label">Endereço</label>
                            <input type="text" name="endereco_bibliotecaria" class="form-control" placeholder="" value="<?php echo $dado['endereco_bibliotecaria'] ?>">
                        </div>
                        <div class="col">
                            <label for="telefone_bibliotecaria" class="form-label">Telefone</label>
                            <input type="text" name="telefone_bibliotecaria" class="form-control" placeholder="" value="<?php echo $dado['telefone_bibliotecaria'] ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label for="email_bibliotecaria" class="form-label">E-mail</label>
                            <input type="email" name="email_bibliotecaria" class="form-control" placeholder="" value="<?php echo $dado['email_bibliotecaria'] ?>">
                        </div>
                        <div class="col">
                            <label for="senha_bibliotecaria" class="form-label">Senha</label>
                            <input type="password" name="senha_bibliotecaria" class="form-control" placeholder="" value="<?php echo $dado['senha_bibliotecaria'] ?>">
                        </div>
                    </div>
